...
namespace MapFeature {
    const MapCoordinate NoshiroSea{Map::NOSIRO_SEA, 40.242865, 140.010450};

    const MapCoordinate NoshiroLand{Map::NOSIRO_LAND, 0, 0};

    const MapCoordinate IzuSea{Map::IZU_SEA, 34.680197, 139.439090};

    const MapCoordinate IzuLand{Map::IZU_LAND, 34.735972, 139.420944};

    const MapCoordinate Unknown{Map::UNKNOWN, 0, 0};
