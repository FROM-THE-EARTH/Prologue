...
namespace Map {
    const MapData NoshiroLand(
        "nosiro_land", MapType::NOSIRO_LAND, 8.9, 40.138624, 139.984906, "nosiro_land.png", 1.0, 1.0, -850, -1200);
    ...
    const MapData IzuLand(
        "izu_land", MapType::IZU_LAND, 7.53, 34.735972, 139.420944, "izu_land.png", 1.00, 1.00, -820, -950);

    const MapData IzuSea(
        "izu_sea", MapType::IZU_SEA, 7.53, 34.680197, 139.439090, "izu_sea.png", 5.77, 5.77, -3080, -6210);
