...
TEST_CASE("Wind profile interpolates from zero wind at ground", "[dynamics][wind]") {
    const WindProfile profile(
        {WindData{.geometricHeight = 100.0, .speed = 4.0, .direction = 90.0},
         WindData{.geometricHeight = 200.0, .speed = 6.0, .direction = 90.0}});
...
TEST_CASE("Wind profile accepts an explicit zero-wind ground observation", "[dynamics][wind]") {
    const WindProfile profile(
        {WindData{.geometricHeight = 0.0, .speed = 0.0, .direction = 45.0},
         WindData{.geometricHeight = 100.0, .speed = 4.0, .direction = 90.0}});
...
TEST_CASE("Wind profile reproduces observations and rejects heights above its range", "[dynamics][wind]") {
    const WindProfile profile(
        {WindData{.geometricHeight = 100.0, .speed = 4.0, .direction = 0.0},
         WindData{.geometricHeight = 200.0, .speed = 6.0, .direction = 90.0}});
...
TEST_CASE("Wind profile interpolates vectors across the north direction", "[dynamics][wind]") {
    const WindProfile profile(
        {WindData{.geometricHeight = 100.0, .speed = 10.0, .direction = 350.0},
         WindData{.geometricHeight = 200.0, .speed = 10.0, .direction = 10.0}});
...
TEST_CASE("Wind profile rejects invalid observations", "[dynamics][wind]") {
    ...
    REQUIRE_THROWS_AS(WindProfile({WindData{.geometricHeight = 0.0, .speed = 1.0, .direction = 0.0}}),
                      std::invalid_argument);
    REQUIRE_THROWS_AS(WindProfile({WindData{.geometricHeight = 100.0, .speed = -1.0, .direction = 0.0}}),
                      std::invalid_argument);
    REQUIRE_THROWS_AS(WindProfile({WindData{.geometricHeight = 200.0, .speed = 1.0, .direction = 0.0},
                                   WindData{.geometricHeight = 100.0, .speed = 1.0, .direction = 0.0}}),
                      std::invalid_argument);
    REQUIRE_THROWS_AS(WindProfile({WindData{.geometricHeight = 100.0,
