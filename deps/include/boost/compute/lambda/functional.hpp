...
#define BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(name) \
    namespace detail { \
...
#define BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(name) \
    namespace detail { \
        struct BOOST_PP_CAT(name, _func) \
        { \
            template<class Expr, class Args> \
...
#define BOOST_COMPUTE_LAMBDA_WRAP___unary_function_ST(name) \
    namespace detail { \
        struct BOOST_PP_CAT(name, _func) \
        { \
            template<class Expr, class Args> \
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(degrees)
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(radians)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(sign)
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_ST(length)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(normalize)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION_ST(fast_distance)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_ST(fast_length)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(fast_normalize)

// Integer Built-In Functions
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(abs)
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(clz)
#ifdef BOOST_COMPUTE_CL_VERSION_2_0
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(ctz)
#endif
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(popcount)
#endif

// Math Built-In Functions
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(acos)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(acosh)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(acospi)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(asin)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(asinh)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(asinpi)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(atan)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(atan2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(atanh)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(atanpi)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(atan2pi)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(cbrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(ceil)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(copysign)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(cos)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(cosh)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(cospi)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(erfc)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(erf)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(exp)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(exp2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(exp10)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(expm1)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(fabs)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(fdim)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(floor)
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(lgamma)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION_PTR(lgamma_r)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(log)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(log2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(log10)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(log1p)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(logb)
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(nan)
...
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(rint)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(rootn)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(round)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(rsqrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(sin)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(sincos)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(sinh)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(sinpi)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(sqrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(tan)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(tanh)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(tanpi)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(tgamma)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(trunc)

// Native Math Built-In Functions
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_cos)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(native_divide)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_exp)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_exp2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_exp10)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_log)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_log2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_log10)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(native_powr)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_recip)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_rsqrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_sin)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_sqrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(native_tan)

// Half Math Built-In Functions
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_cos)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(half_divide)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_exp)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_exp2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_exp10)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_log)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_log2)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_log10)
BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION(half_powr)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_recip)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_rsqrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_sin)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_sqrt)
BOOST_COMPUTE_LAMBDA_WRAP___unary_function_T(half_tan)
...
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(isfinite)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(isinf)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(isnan)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(isnormal)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN_BINARY_FUNCTION(isordered)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN_BINARY_FUNCTION(isunordered)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(singbit)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(all)
BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN___unary_function(any)
